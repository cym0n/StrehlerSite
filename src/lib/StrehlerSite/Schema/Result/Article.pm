use utf8;
package StrehlerSite::Schema::Result::Article;
...
Related object: L<StrehlerSite::Schema::Result::Content>

=cut

__PACKAGE__->has_many(
  "contents",
  "StrehlerSite::Schema::Result::Content",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:KbNaqJsg3Tznj9GR5p8XIg
